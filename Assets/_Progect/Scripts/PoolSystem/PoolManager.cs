...
public class PoolManager : MonoBehaviour
{
    ...
    /// <summary>
    /// Restituisce l'oggetto con ID specificato
    /// </summary>
    ...
    /// <summary>
    /// Restituisce l'oggetto con ID specificato settandogli parent e posizione
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <param name="_id"></param>
    /// <param name="_position"></param>
    /// <param name="_parent"></param>
    /// <returns></returns>
    public T GetFirstAvaiableObject<T>(string _id, Transform _parent, Vector3 _position) where T : PoolObjectBase
    {
        Pooler<PoolObjectBase> pool = GetPooler<T>(_id);
        T obj = (T)pool.GetFirstCollectable();
        SetPoolObjectParent(obj, _parent);
